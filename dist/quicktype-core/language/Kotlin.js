...
class KotlinRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
    ...
    kotlinImport(t) {
        return TypeUtils_1.matchType(t, _anyType => [], _nullType => [], _boolType => [], _integerType => [], _doubleType => [], _stringType => [], arrayType => [...this.kotlinImport(arrayType.items)], _classType => [], mapType => [...this.kotlinImport(mapType.values)], _enumType => [], unionType => {
            const imports = [];
    ...
    emitImports() {
        const imports = this._dateTimeProvider.imports;
        this.forEachNamedType("leading-and-interposing", (c) => {
